...
| **Suite de Pruebas Unitarias** | `pytest tests/` | **PASS** | 154 pruebas aprobadas en Fase 3A.1: núcleo LP, restricciones constantes factibles/infactibles, salvaguarda temporal de nombres, integridad numérica, ponderaciones normalizadas, hidroeléctrico, persistencia JSON dispersa, importación ancha/dispersa CSV/TSV/XLSX, rechazo de macros, lotes de 50/500 restricciones, matriz dispersa 1.000×100 y recorridos Streamlit con AppTest. |
