...
| [`streamlit_app.py`](../streamlit_app.py) | Aplicación web interactiva Streamlit (hasta 100 variables con nombres personalizados, versionado de widgets y carga atómica). |
...
| [`tests/test_hydroelectric_e2e.py`](../tests/test_hydroelectric_e2e.py) | Pruebas end-to-end de resolución directa de fixture, fidelidad de operadores/RHS y transiciones de carga AppTest (4 tests). |
| [`tests/fixtures/hydroelectric_full_24_vars.json`](../tests/fixtures/hydroelectric_full_24_vars.json) | Fixture canónico oficial del modelo hidrotérmico multiperíodo (24 variables, 28 restricciones, Schema 1.0). |
